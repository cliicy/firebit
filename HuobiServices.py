...
def get_spot_openorders(symbol,acct_id=None):
    ...
    params = {"account-id": acct_id,"symbol":symbol}

    return api_key_get(params, url)

#查询借贷用户下未成交订单
def get_margin_openorders(symbol,acct_id=None):
...
if __name__ == '__main__':
    ...
    #print(get_balance())
    #市价买
    #print(send_order(amount=1,symbol='xrpusdt',_type='buy-market'))

    #print(orders_matchresults(symbol='xrpusdt'))
    #print(order_matchresults(9199242148))
   #print(order_info(9199242148))
   #print(cancel_order(9199242148))
   #限价卖
   #print(send_order(amount=1, symbol='xrpusdt', _type='buy-limit',price=0.0001))

   #print(orders_matchresults(symbol='xrpusdt'))

   #print(orders_list(symbol='xrpusdt',states='filled'))
    #现货账户未成交的订单查询
    #print(get_spot_openorders(symbol='xrpusdt'))
# 借贷账户未成交的订单查询
    #print(cancel_order(9668546334))
    #print(get_margin_openorders(symbol='xrpusdt'))

   #print(order_info(11276024044))
    #print(get_kline("eosbtc","1min",size=2000))
    #查询借贷订单
    #print(loan_orders(symbol="xrpusdt",currency="usdt"))
    #申请借贷（币种有借贷最小金额上限）
    #print(get_margin(symbol="xrpusdt", currency="usdt", amount=0.00001))
    #print(send_margin_order(amount=1,symbol="xrpusdt",_type="buy-limit",price = 0.1,source="margin-api"))

    #9668546334


   # result = get_kline("eosbtc","1min",size=2000)
   ...
   # to_ts = 1534089599
    ...
    #for item in json_result:
        #if item["id"] >= from_ts and item["id"] <= to_ts:
            #print(item)
           # r_lest.append((item))
